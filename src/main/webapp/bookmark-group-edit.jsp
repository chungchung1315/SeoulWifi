        ...
        <table class="table-list">
            <tbody>
                <tr>
                    ...
                    <td>
                        <input type="text" id="bookmark-name" name="bookmark-name" value="<%= group.getBookmarkName() %>" />
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                        <input type="text" id="bookmark-priority" name="bookmark-priority" value="<%= group.getPriority() %>" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2" style='text-align: center;'>
                        ...
                        <input type="hidden" id="bookmark-action" name="bookmark-action" value="edit" />
